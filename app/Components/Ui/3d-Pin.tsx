...
export const PinPerspective = ({
  ...
  return (
    <div className=" w-full h-full -mt-7 flex-none  inset-0">
      <motion.div key={title} className="pointer-events-none  w-full   h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
