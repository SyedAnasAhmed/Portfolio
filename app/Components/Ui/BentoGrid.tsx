...
export const BentoGridItem = ({
  ...
  const handlecopy = () => {
    navigator.clipboard.writeText("syedanasahmed412@gmail.com");
    setcopied(true);
  };
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute z-50 flex justify-center item-center text-white font-bold" />
          </BackgroundGradientAnimation>
        )}
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {["Express.js", "Next.js", "React.js"].map((item) => (
                  <span
                    key={item}
